...
@Config
@Autonomous(name = "A4AutonVoyager", group = "Autonomous")
public class A4AutonVoyager extends LinearOpMode {
    public class Func {
    ...
    public void runOpMode() {
        Pose2d initialPose = new Pose2d(0, -40, Math.toRadians(-90));
