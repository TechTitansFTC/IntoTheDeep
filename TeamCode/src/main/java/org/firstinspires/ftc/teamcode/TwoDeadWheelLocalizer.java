...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -78.73057473249246; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -500; // x position of the perpendicular encoder (in tick units)
    }
