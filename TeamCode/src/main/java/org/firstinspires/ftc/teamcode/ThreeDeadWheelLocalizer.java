...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -96.57308071004937; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 93.45425148619886; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -24.996395724828197; // x position of the perpendicular encoder (in tick units)
    }
